import {ComponentFixture, ComponentFixtureAutoDetect, fakeAsync,  tick, async} from '@angular/core/testing';
...
describe('AssemblylineComponent', () => {
  ...
  beforeEach(async(() => {
    ...
    configureTests(configure).then((testBed: {
      createComponent: (arg0: typeof TestComponentWrapper) => ComponentFixture<TestComponentWrapper>;
    }) => {
